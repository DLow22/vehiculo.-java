    ...
    public class TestVehiculos {
        ...
        try {Scanner entrada = new Scanner (System.in)} {
            String placa, marca, modelo;
                int kilometraje;
                System.out.println("Favor de ingresar placa: ");

                placa = entrada.nextLine();
                System.out.println("Favor de ingrasar maraca: ");
                marca = entrada.nextLine();
                System.out.println("Favor de ingresar modeelo: ");
                modelo = entrada.nextLine();
                System.out.println("Favor de ingresar Kilometraje: ");
